...
const reviews = [
  ...
  },
  {
    ...
    rating: 4,
    date: "22/06/2023",
    comment: "Encontré una tarifa de Internet mucho mejor que la que tenía. El comparador es muy fácil de usar.",
    avatarSrc: "/placeholder.svg?height=40&width=40",
    verifiedPurchase: true,
  ...
  },
  {
    ...
    rating: 5,
    date: "10/07/2023",
    comment: "Excelente servicio. Me ayudaron a entender mi factura y a elegir la mejor tarifa para mi negocio.",
    avatarSrc: "/placeholder.svg?height=40&width=40",
    verifiedPurchase: true,
    service: "luz" as const,
  },
