    ...
    <div className="container py-12">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={potencia.toString()} onValueChange={(value) => setPotencia(Number.parseFloat(value))}>
              <SelectTrigger>
      ...
      {resultado !== null && (
        <Card className="mt-6">
          ...
          <CardContent>
            <p className="text-2xl font-bold text-green-600">Ahorro anual estimado: {resultado.toFixed(2)}€</p>
            <p className="text-sm text-muted-foreground mt-2">
              Este es un cálculo aproximado basado en los datos proporcionados y las tarifas promedio del mercado. El
              ahorro real puede variar dependiendo de diversos factores.
            </p>
          </CardContent>
        </Card>
      )}
