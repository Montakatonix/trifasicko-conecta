...
export const metadata: Metadata = {
  ...
  description:
    'Conoce las compañías de energía e Internet con las que trabajamos para ofrecerte las mejores tarifas.',
}
  ...
  return (
    <div className='container py-12'>
      ...
      <p className='text-muted-foreground mb-8'>
        Trabajamos con las mejores compañías de energía e Internet para ofrecerte una amplia gama de
        opciones y las tarifas más competitivas.
      </p>
