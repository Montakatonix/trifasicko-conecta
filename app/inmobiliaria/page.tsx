...
import type { Inmueble, FiltrosInmuebles } from "@/lib/types"
...
import { 
  Loader2, Home, Building, Store, Building2, Euro, 
  Ruler, BedDouble, Bath, MapPin, Phone, Mail,
  Zap, Droplet, Flame, Wifi, ArrowRight, Box
} from "lucide-react"
...
const inmueblesEjemplo: Inmueble[] = [
  {
    ...
    descripcion: "Magnífico piso totalmente reformado con las mejores calidades. Cuenta con sistema de aerotermia, paneles solares y domótica integrada para máxima eficiencia energética.",
    precio: 295000,
    superficie: 90,
    habitaciones: 3,
    banos: 2,
  ...
  },
  {
    ...
    descripcion: "Espectacular chalet independiente en urbanización privada. Cuenta con piscina, jardín y garaje para dos coches. Excelente eficiencia energética gracias a su orientación y materiales.",
    precio: 495000,
    superficie: 250,
    habitaciones: 4,
    banos: 3,
...
export default function InmobiliariaPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <Tabs value={operacion} onValueChange={(v) => {
                  ...
                  <CardHeader>
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <Badge className={`bg-green-${
                        inmueble.eficienciaEnergetica.certificado === "A" ? "500" :
                        inmueble.eficienciaEnergetica.certificado === "B" ? "400" :
                        "300"
                      }`}>
