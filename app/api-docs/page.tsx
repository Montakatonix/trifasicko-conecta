  ...
  return (
    <div className="container py-12">
      ...
      <p className="text-muted-foreground mb-8">
        Bienvenido a la documentación de la API de Trifasicko Conecta. Esta API permite a los desarrolladores acceder a
        nuestros datos de tarifas de luz e internet.
      </p>

      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Autenticación</h2>
        <p>
          Actualmente, la API no requiere autenticación. Sin embargo, en el futuro, implementaremos un sistema de API
          keys para un acceso más seguro y controlado.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Actualmente no hay límites de uso establecidos. Sin embargo, te pedimos que hagas un uso responsable de la API
          para garantizar su disponibilidad para todos los usuarios.
        </p>
      </section>
    </div>
  )
