...
import { BarChartIcon, BoltIcon, ShieldCheckIcon, WifiIcon } from 'lucide-react'
            ...
            <div className='flex flex-col justify-center space-y-4'>
              <div className='space-y-2'>
                ...
                <p className='max-w-[600px] text-muted-foreground md:text-xl'>
                  Compara y encuentra las mejores tarifas adaptadas a tu consumo. Trifasicko Conecta
                  te ayuda a pagar menos cada mes.
                </p>
              </div>
        ...
        <div className='container px-4 md:px-6'>
          <div className='flex flex-col items-center justify-center space-y-4 text-center'>
            <div className='space-y-2'>
              ...
              <p className='max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed'>
                Descubre cómo Trifasicko Conecta puede ayudarte a optimizar tus gastos en servicios
                esenciales
              </p>
            </div>
          </div>
          <div className='mx-auto grid max-w-5xl items-center gap-6 py-12 md:grid-cols-2 lg:grid-cols-4'>
            ...
            <Card className='bg-card'>
              ...
              <CardContent>
                <p className='text-muted-foreground'>
                  Análisis detallado de tu consumo para optimizar tus facturas
                </p>
              </CardContent>
            </Card>
            <Card className='bg-card'>
              ...
              <CardContent>
                <p className='text-muted-foreground'>
                  Tus datos siempre protegidos con nuestro sistema de seguridad
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className='mx-auto grid max-w-5xl items-center gap-6 py-12 md:grid-cols-3'>
            <Card className='bg-card'>
              <CardHeader>
                ...
                <CardDescription>
                  Completa un sencillo formulario con tu consumo actual
                </CardDescription>
              </CardHeader>
            </Card>
            <Card className='bg-card'>
              <CardHeader>
                ...
                <CardDescription>
                  Nuestro sistema encuentra las mejores tarifas para ti
                </CardDescription>
              </CardHeader>
            </Card>
            <Card className='bg-card'>
        ...
        <div className='container px-4 md:px-6'>
          <div className='flex flex-col items-center justify-center space-y-4 text-center'>
            <div className='space-y-2'>
              ...
              <p className='max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed'>
                Descubre cómo Trifasicko Conecta ha ayudado a miles de personas y empresas a ahorrar
                en sus facturas de luz e Internet.
              </p>
            </div>
          </div>
