...
const pressItems = [
  ...
  },
  {
    ...
    description:
      'La startup española planea expandir sus servicios a otros países europeos con esta nueva inversión.',
    logo: '/placeholder.svg?height=50&width=100',
    type: 'noticia',
  },
  ...
  return (
    <div className='container py-12'>
      ...
      <p className='text-muted-foreground mb-8'>
        Descubre las últimas noticias, menciones en medios y premios recibidos por Trifasicko
        Conecta.
      </p>
