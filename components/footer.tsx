        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Tu comparador de tarifas de luz e Internet. Encuentra las mejores ofertas y ahorra en tus facturas.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/comparador-luz" className="text-muted-foreground hover:text-foreground">
                  Comparador de Luz
                </Link>
              </li>
              <li>
                <Link href="/comparador-internet" className="text-muted-foreground hover:text-foreground">
                  Comparador de Internet
                </Link>
              </li>
              <li>
                <Link href="/asesoria-energetica" className="text-muted-foreground hover:text-foreground">
                  Asesoría Energética
                </Link>
              </li>
              <li>
                <Link href="/optimizacion-facturas" className="text-muted-foreground hover:text-foreground">
